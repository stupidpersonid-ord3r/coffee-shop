    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          // Jangan tampilkan notif kalau status sebenarnya sama
          if (payload.old.status !== newStatus) {
            ...
            if (step) {
              ...
              // Hilangkan notification otomatis
              setTimeout(() => {
        ...
        <div className="fixed top-24 right-5 z-50 w-[calc(100%-40px)] max-w-sm animate-[slideIn_0.4s_ease-out]">
          <div className="bg-white border border-green-200 shadow-2xl rounded-2xl p-5">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center text-2xl shrink-0 animate-bounce">
                {notification.icon}
              </div>
